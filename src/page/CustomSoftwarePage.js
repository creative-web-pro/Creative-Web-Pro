...
import { custom_software_services, custom_software_benefitsList, custom_software_resultsList } from '@/data/data';
...
const CustomSoftwarePage = memo(function CustomSoftwarePage() {
    return (
        <section className="min-h-screen bg-background text-foreground max-w-7xl mx-auto space-y-20 py-16 px-4">
            ...
            <section className="text-justify space-y-4">
                <Title
                    ...
                    subTitle="Tailor-Made Software Solutions to Match Your Unique Business Needs"
                />
                <p className="max-w-6xl mx-auto text-lg text-foreground/60 leading-relaxed">
                    At Creative Web Pro, we design, build, and scale custom software solutions that solve real business challenges. Whether you need a complete platform, mission-critical backend system, or internal workflow tool — we engineer it to your exact specifications with speed, security, and scalability. Our solutions help enterprises automate, integrate, and scale operations with precision and flexibility that off-the-shelf software can&apos;t deliver.
                </p>
            </section>
            ...
            <section className="space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {custom_software_services.map((service, idx) => (
            ...
            <section className="space-y-10">
                ...
                <FeaturesSection processSteps={custom_software_resultsList} />
            </section>
            ...
            <section className="bg-foreground rounded-3xl p-8 md:p-12 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {custom_software_benefitsList.map((benefit, idx) => (
            ...
            <section className="text-center space-y-6 py-14">
                <div className="space-y-4 pb-6">
                    ...
                    <p className="text-foreground/60 max-w-xl mx-auto">
                        Let&apos;s build custom software that automates workflows, unlocks efficiencies, and drives sustainable growth.
                    </p>
                </div>
                <Link
                    href="/contact"
